...
import { ChangePasswordFormPayloadDto } from './dto/change-password-form.payload.dto';
...
export class UserSecretsController {
  ...
  changePassword(@LoginUser() user: LoginUserData, @Body() changePasswordDto: ChangePasswordFormPayloadDto) {
